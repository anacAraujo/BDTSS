...
<section class="sec-filmes pb-5 mt-5" id="filmes">
    <div class="container px-lg-5 pt-3">
        ...
        <div class="row">
            ...
            // Define the query
            $query = "SELECT titulo, capa , tipo FROM filmes INNER JOIN generos ON generos.id_generos = filmes.ref_generos ORDER BY ano DESC LIMIT 3;";
            ...
            if (mysqli_stmt_prepare($stmt, $query)) {
                ...
                if (mysqli_stmt_execute($stmt)) {
                    ...
                    mysqli_stmt_bind_result($stmt, $titulo, $capa, $genero);
